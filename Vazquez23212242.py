...
Nombre del alumno: Javier Vazquez Gomez
Número de control: 23212242
Correo institucional: l23212242@tectijuana.edu.mx
...
kP,kI,kD = 289.6613,7061.5105,0.39134
Cr = 1E-6
Re = 1/(Cr*kI)
Rr = kP*Re
Ce = kD/Rr
...
print(f"El valor de la transferencia del controlador PID: {PID}.\n")

#Sistema de control en lazo cerrado
sysPID = ctrl.feedback(ctrl.series(PID,sys),1,sign = -1)
print(f"Funcion de transferencia del sistema de control enn lazo cerrado: {sysPID}")
...
for i in range(0,4):
    ...
    plt.xlabel('t [S]')
    plt.ylabel('Vi(t) [V]')
    plt.legend(bbox_to_anchor = (0.5,-0.25), loc='center' ,ncol=3, frameon=True)
    plt.show()
